...
extern "C" int WINAPI wWinMain(HINSTANCE instance, HINSTANCE prev, wchar_t*, int nShowCmd) {
#else
int main() {
...
#elif !defined(WIN_CONSOLE_APP) 
	::OleInitialize(nullptr);
    if (::LoadLibrary(L"tangramcore.dll") == nullptr) {
      ...
      if (hr == S_OK) {
        ...
        if (::PathFileExists(m_strProgramFilePath)) {
          ::LoadLibrary(m_strProgramFilePath);
        }
      }
    }
#endif
