...
// begin ChromeProxy
#include "chrome_proxy/public/ChromeProxy.h"
#include "chrome_proxy/public/serialization.h"
// end ChromeProxy
...
class CONTENT_EXPORT RenderFrameHostImpl :
 ...
 private:
  ...
  void OnTangramMessage(std::wstring channel, std::wstring arg1, std::wstring arg2);
  void SendTangramMessage(std::wstring channel, std::wstring arg1, std::wstring arg2) override;
  // end ChromeProxy
