...
## Debug 
1. Download [Symbols](https://github.com/TangramDev/Tangram/releases).
2. Mounted at `{{Tangram install Directory}}\chrome\{{chrome-vesion Directory }}` .
3. Select TangramCore Project to debug.
4. Follow breakpoints in engineering and be familiar with code.
